...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default = "/data/guest_storage/zhanpengluo/SLAM/4d-gaussian-splatting/configs/nvidia/Balloon1_colmap.yaml",type=str)
    parser.add_argument('--debug_from', type=int, default=-1)
    parser.add_argument('--detect_anomaly', action='store_true', default=False)
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[7_000])
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[1_000,3000,10000])
