...
def make_transforms(intrinsic, cam_c2w, save_dir, scene ,W):
    ...
    # dycheck_path = "/data/zhanpeng/davis/DAVIS/JPEGImages/480p"
    dycheck_path = "/data/zhanpeng/davis/DAVIS/JPEGImages/1080p"
    ...
    for i in selected:
        frame_dict = {
            "file_path": f"{dycheck_path}/{scene}/{i:05d}",
...
if __name__ == "__main__":
    ...
    save_dir = "/home/zhanpeng/code/SLAM/reconstruct/MegaSAM_GS/voxel_filter/output/davis_speed"
    
    motion_dir_mask_dir =  "/data/zhanpeng/davis/DAVIS/Annotations/480p"
